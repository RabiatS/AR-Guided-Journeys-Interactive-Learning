...
namespace Oculus.Interaction.Samples
{
    public class CustomDropDownGroup : MonoBehaviour
    {
        ...
        [SerializeField]
        [Tooltip("Update the header labels with the default selection when the dropdown first initializes.")]
        private bool _updateHeaderOnStart = true;
        ...
        bool _suppressInitialHeaderSync;
        ...
        protected virtual void OnEnable()
        {
            if (_started)
            {
                _suppressInitialHeaderSync = !_updateHeaderOnStart;
        ...
        private void HandleToggleChanged(bool isOn, int index)
        {
            if (isOn && index >= 0)
            {
                ...
                bool shouldUpdateHeader = !_suppressInitialHeaderSync;
                ...
                SelectedIndex = index;
                _suppressInitialHeaderSync = false;
            }
        }
